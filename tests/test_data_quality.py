...
def test_validate_historical_data_valid(tmp_path):
    ...
    # Insert valid data
    c.execute(
        "INSERT INTO world_cups VALUES (1, 2022, 'Qatar', 'Argentina', 'France', 'Mbappe', 8, 64, 172, 3400000)"
    )
    c.execute("INSERT INTO teams VALUES (1, 1, 'Argentina', 'CONMEBOL')")
    c.execute("INSERT INTO teams VALUES (2, 1, 'France', 'UEFA')")
    c.execute(
        "INSERT INTO matches VALUES (1, 1, 'Final', NULL, 64, '2022-12-18', 'Argentina', 'France', 3, 3, 2, 4, 1, 88966)"
    )
    c.execute("INSERT INTO goals VALUES (1, 1, 64, 'France', 'Mbappe', 8, 0)")
    c.execute("INSERT INTO goals VALUES (2, 1, 64, 'Argentina', 'Messi', 7, 0)")
    c.execute(
        "INSERT INTO group_standings VALUES (1, 1, 'A', 'Argentina', 1, 3, 2, 0, 1, 5, 2, 3, 6, 1)"
    )
    c.execute(
        "INSERT INTO group_standings VALUES (2, 1, 'A', 'France', 2, 3, 1, 1, 1, 3, 2, 1, 4, 1)"
    )
    c.execute(
        "INSERT INTO group_standings VALUES (3, 1, 'A', 'Poland', 3, 3, 1, 0, 2, 2, 4, -2, 3, 0)"
    )
    c.execute(
        "INSERT INTO group_standings VALUES (4, 1, 'A', 'Mexico', 4, 3, 0, 1, 2, 1, 3, -2, 1, 0)"
    )
...
def test_validate_historical_data_negative_scores(tmp_path):
    ...
    c.execute(
        "INSERT INTO matches VALUES (1, 1, 'Final', NULL, 64, '2022-12-18', 'Argentina', 'France', -1, 3, 2, 4, 1, 88966)"
    )
    c.execute("INSERT INTO goals VALUES (1, 1, 64, 'France', 'Mbappe', 8, 0)")
    c.execute(
        "INSERT INTO group_standings VALUES (1, 1, 'A', 'Argentina', 1, 3, 2, 0, 1, 5, 2, 3, 6, 1)"
